(function ($) {
    ...
    $.fn.wikiEliminarResponsable = function (id) {
        ...
        if (id === "d-10") {
            ...
            $("#panel-foot-down").html("Responsable");
            ...
            $("#panel-foot")
                    .append($("<div>").addClass("col-lg-12")
                            .append($("<div>").addClass("col-lg-10").attr({"id": "row-foot-10"})
                    ...
                    if (data !== undefined) {
                        ...
                        $("#tbody-10")
                                .append($("<tr>").attr({"id": data.id, "value": "1"})
                                        .append($("<td>").html("Responsable " + data.id.split("_")[1]).attr({"width": "20%"}))
        ...
        function eventRemove() {
            ...
            ajaxDelete10(tableId);
            $(this).parent().parent().remove();

        }

        function ajaxDelete10(id) {
            $.ajax({
                url: "WikiWeb/responsible/delete",
                data: {
                    id: id
                },
                method: "POST"
            }).done(function () {
                swal({title: "Eliminacion Compeltada!!!", text: "Se elimino correctamente el responsable", timer: 2000, showConfirmButton: false, type: "success"});
