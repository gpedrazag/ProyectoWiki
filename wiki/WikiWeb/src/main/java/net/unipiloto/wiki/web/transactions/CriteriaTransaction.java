...
{
    public static void insert(String keyword, String description, List<String> linkedEvaluations) throws IOException, URISyntaxException
    {
    ...
    {
        delete(id);
        insert(keyword, description, linkedEvaluations);
    }
