(function ($) {
    ...
    $.fn.wikiMainPage = function () {
        ...
        $("#row-content")
                .prepend($("<div>").addClass("row can-remove")
                        .append($("<div>").addClass("col-lg-6")
                                .append($("<h2>").addClass("page-header").html("Proyecto PUA"))
                                )
                        );
        $("#left-row").addClass("cant-remove")
                .append($("<div>").addClass("can-remove")
