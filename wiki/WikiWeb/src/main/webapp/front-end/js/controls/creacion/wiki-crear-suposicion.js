    ...
    $.fn.wikiCrearSuposicion = function (id) {
        ...
        if (id === "c-13") {
           ...
           $("#left-row").empty();
            ...
            $("#panel-heading-left").html("Suposicion");
        ...
        function ajaxInsert13(description, source)
        {
            $.ajax({
                ...
                swal({title: "Creacion Compeltada!!!", text: "Se creo correctamente la suposicion", timer: 2000, showConfirmButton: false, type: "success"});
