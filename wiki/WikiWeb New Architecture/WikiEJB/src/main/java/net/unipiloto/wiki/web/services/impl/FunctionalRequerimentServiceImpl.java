...
import net.unipiloto.wiki.web.services.FunctionalRequerimentService;
...
@Stateless(mappedName = "java:global/FunctionalRequerimentService")
public class FunctionalRequerimentServiceImpl implements FunctionalRequerimentService
{
    @Override
